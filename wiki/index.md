...
The tokamak already features a fast spectrometer, which is composed of beam splitters, spectral filters and free-space biased detectors. However, this configuration follows only four spectral lines, has poor signal-to-noise ratio and does not detect frequencies above $1\text{ kHz}$.
...
In addition to optical filters, dichroic mirrors, and the supporting infrastructure for the optical components, new [DET100A2](https://www.thorlabs.com/thorproduct.cfm?partnumber=DET100A2) photodiodes from Thorlabs were procured. These are intended to replace the existing detectors to provide a higher output signal. To calculate the bandwidth of these diodes, the following formula was employed [2]:

$$f_{BW} = \frac{1}{2\pi R_{LOAD} \times C_j}$$

$f_{BW}$ is the bandwidth measured in Hz. This represents the maximum frequency at which the photodiode can accurately follow the modulation of the light.
...
The spectroscope was assembled and prepared for future testing. All resistors had value of $1\text{ M}\Omega$ (except the shots mentioned in the following section) and the detectors were connected to the osciloscope according to the following table

| Channel | Spectral Line | Wavelength |
| ------- | ------------- | ---------- |
| ch1     | He I          | 447.1 nm   |
| ch2     | O I           | 777.0 nm   |
| ch3     | N II          | 568.6 nm   |
...
> Shots #50917 - present (at least until 12.1.2026)
...
The modified connections to the osciloscopes are listed in the table below:
...
[2] Thorlabs, Inc., "Photodiode Tutorial," Thorlabs.com. [Online]. Available: https://www.thorlabs.com/free-space-biased-detectors?tabName=Photodiode%2520Tutorial
